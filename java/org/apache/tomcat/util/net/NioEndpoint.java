...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel> {
    ...
    protected boolean setSocketOptions(SocketChannel socket) {
        ...
        try {
            ...
            System.out.println("getPoller0().register(channel)");
            //register Poller 注册
    ...
    protected class Acceptor extends AbstractEndpoint.Acceptor {
        ...
        public void run() {
            ...
            while (running) {
                System.out.println("org.apache.tomcat.util.net.NioEndpoint.Acceptor.run");
                // Loop if endpoint is paused
                // paused 为true 是为停止。
                while (paused && running) {
                    state = AcceptorState.PAUSED;
                    try {
                        System.out.println("暂停50微秒");
                        Thread.sleep(50);
                    } catch (InterruptedException e) {
                        // Ignore
                    }
                ...
                try {
                    ...
                    if (running && !paused) {
                        ...
                        System.out.println("setSocketOptions run caoxiaoyang");
                        System.out.println("org.apache.tomcat.util.net.NioEndpoint.setSocketOptions");
    ...
    public static class PollerEvent implements Runnable {
        ...
        @Override
        public void run() {
            System.out.println("org.apache.tomcat.util.net.NioEndpoint.PollerEvent.run impl");
            if (interestOps == OP_REGISTER) {
                ...
                try {
                    if (key == null) {
                        ...
                        // closed.
                        System.out.println("org.apache.tomcat.util.net.AbstractEndpoint.countDownConnection");
    ...
    public class Poller implements Runnable {
        ...
        public boolean events() {
            ...
            for (int i = 0, size = events.size(); i < size && (pe = events.poll()) != null; i++ ) {
                result = true;
                try {
                    System.out.println("org.apache.tomcat.util.net.NioEndpoint.PollerEvent.run");
                    pe.run();
                    pe.reset();
                    if (running && !paused) {
                        eventCache.push(pe);
        ...
        public void register(final NioChannel socket) {
            System.out.println("org.apache.tomcat.util.net.NioEndpoint.Poller.register");
        ...
        public void run() {
            ...
            System.out.println("org.apache.tomcat.util.net.NioEndpoint.Poller.run");
            while (true) {
                boolean hasEvents = false;

                try {
                    System.out.println("org.apache.tomcat.util.net.NioEndpoint.Poller.selector");
                    if (!close) {
                        hasEvents = events();
                ...
                while (iterator != null && iterator.hasNext()) {
                    ...
                    if (attachment == null) {
                        ...
                        System.out.println("java.util.Iterator.remove 移除队列中。。。");
                        iterator.remove();
                    ...
                    if (sk.isReadable() || sk.isWritable() ) {
                        if ( attachment.getSendfileData() != null ) {
                            ...
                            if (sk.isReadable()) {
                                ...
                                System.out.println("java.nio.channels.SelectionKey.isReadable processSocket");
                                if (!processSocket(attachment, SocketEvent.OPEN_READ, true)) {
                                    closeSocket = true;
                                }
                            }
                            if (!closeSocket && sk.isWritable()) {
                                System.out.println("java.nio.channels.SelectionKey.isWritable processSocket");
    ...
    protected class SocketProcessor extends SocketProcessorBase<NioChannel> {
        ...
        protected void doRun() {
            System.out.println("请求org.apache.tomcat.util.net.NioEndpoint.SocketProcessor.doRun=="+2);
