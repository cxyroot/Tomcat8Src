...
public class Catalina {
    ...
    protected Digester createStartDigester() {
        ...
        System.out.println("org.apache.catalina.startup.Catalina.createStartDigester");
     ...
     */
    public void load() {
        System.out.println("org.apache.catalina.startup.Catalina.load()");
        if (loaded) {
            return;
        }
        loaded = true;
