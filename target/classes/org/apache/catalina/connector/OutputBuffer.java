...
public class OutputBuffer extends Writer {
    ...
    public void close() throws IOException {
        System.out.println("org.apache.catalina.connector.OutputBuffer.close");
        if (closed) {
            return;
        }
        if (suspended) {
        ...
        if (cb.remaining() > 0) {
            //刷出缓冲区。
            System.out.println("org.apache.catalina.connector.OutputBuffer.flushCharBuffer");
            flushCharBuffer();
        }
        ...
        System.out.println("org.apache.catalina.connector.OutputBuffer.coyoteResponse"+"====="+"org.apache.catalina.connector.Request");
